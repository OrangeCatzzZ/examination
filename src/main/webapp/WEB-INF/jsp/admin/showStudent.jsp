				    ...
				    <table class="table table-bordered">
							...
							<c:forEach  items="${studentList}" var="item">
								<tr>
									...
									<td>
										<button class="btn btn-default btn-xs btn-info" onClick="location.href='${pageContext.request.contextPath}/admin/editStudent?id=${item.student.userid}'">修改</button>
										<button class="btn btn-default btn-xs btn-danger btn-primary" onClick="location.href='${pageContext.request.contextPath}/admin/removeStudent?id=${item.student.userid}'">删除</button>
										<!--弹出框-->
									</td>
								</tr>
							</c:forEach>
				    ...
				    <div class="panel-footer">
						<c:if test="${page != null}">
							<nav style="text-align: center">
								<ul class="pagination">
									<c:if test="${page>2 }">
										<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=1">&laquo;第一页</a></li>
									</c:if>
									<c:if test="${page>1 }">
										<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=${page-1 }">&laquo;上一页</a></li>
									</c:if>
									<%-- <li class="active"><a href="">${pagingVO.curentPageNo}</a></li> --%>
									<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=${page+1 }">下一页&raquo;</a></li>
									...
									<li><a href="${pageContext.request.contextPath}/admin/showStudent?page=${endPage }">最后一页&raquo;</a></li>
								</ul>
							</nav>
						</c:if>
				    </div>
